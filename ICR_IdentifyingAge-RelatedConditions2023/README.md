...
## Environment setup
```
    conda create -n ICR_2023 python=3.10 ipython
    conda activate ICR_2023

    conda install -c conda-forge pytorch-gpu=2.0.0 tensorflow-gpu torchvision opencv
    conda install -c conda-forge matplotlib seaborn scikit-learn scikit-image jupyter 
    conda install -c conda-forge kaggle
```

## Note
The tensorflow-decision-foresets have the [compatibility note for tensorflow version](https://github.com/tensorflow/decision-forests/blob/main/documentation/known_issues.md#compatibility-table)